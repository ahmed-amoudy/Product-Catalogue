...
import shapeimg1 from "../../assets/images/shape-img/icon/01.png";
import shapeimg2 from "../../assets/images/shape-img/icon/02.png";
  ...
  return (
    <div className="course-section style-3 padding-tb">
      <div className="course-shape one">
        <img src={shapeimg1} alt="education" />
      </div>
      <div className="course-shape two">
        <img src={shapeimg2} alt="education" />
      </div>
